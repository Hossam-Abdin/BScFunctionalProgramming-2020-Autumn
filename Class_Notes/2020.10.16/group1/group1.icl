...
//| [x:xs] == [x] = [x]
| xs == [[]] = [x]
| length x < 3 = [x] ++ insert xs y
| length x >= 3
= [take y x ++ [3] ++ drop y x] ++ insert xs y


// Start = insert [[1,2,2,2]] 3

// Start = insert [[1,2,3],[3],[4,5,6,7],[],[0,1,6,3,5]] 3  //[[1,2,3,3],[3],[4,5,6,3,7],[],[0,1,6,3,3,5]]
// Start = insert [[1,2,6,8,3],[9,3],[0,5,0,6,7],[],[0,1,6,3,5,8]] 3  //[[1,2,6,3,8,3],[9,3],[0,5,0,3,6,7],[],[0,1,6,3,3,5,8]]
// Start = insert [[0],[3],[4,5,6],[],[0,1,6,9,7,3,5]] 3  //[[0],[3],[4,5,6,3],[],[0,1,6,3,9,7,3,5]]